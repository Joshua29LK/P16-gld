...
class CheckoutSubmitAllAfter implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $collection = $this->_modelProfiles->getCollection()->searchProfiles(explode(',', (string) $this->_helperData->getStoreConfig("ordersexporttool/advanced/execute_on_checkout")));
