...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '2.0.13', '<')) {
            $this->addCustomerGroupFieldMenuAlignment($setup);
        }
    }
    ...
    protected function addCustomerGroupFieldMenuAlignment(SchemaSetupInterface $setup)
    {
        $setup->getConnection()->addColumn(
            $setup->getTable('megamenu_menus'),
            'menu_alignment',
            ...
            'length' => 255,
            'nullable' => true,
            'comment' => 'Menu Alignment',
            'after' => 'menu_design_type'
                ]
        );
    }
}
