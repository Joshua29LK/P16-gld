...
//        }
        ...
        $oetTable = $installer->getConnection()
            ...
            ->addColumn(
                ...
                500,
                ['nullable' => true],
                'Message for update order status'
            )
            ->addColumn(
                'date_format',
                \Magento\Framework\DB\Ddl\Table::TYPE_TEXT,
            ...
            ->addIndex(
                $installer->getIdxName('ordersexporttool', ['id']),
                ['id']
            )
            ->setComment('Mass Order Export Profiles Table');
        ...
        $oetVariablesTable = $installer->getConnection()
            ...
            ->addIndex(
                $installer->getIdxName('ordersexporttool_variables', ['id']),
                ['id']
            )
            ->setComment('Mass Order Export Custom Variables Table');
        ...
        $oetFunctionsTable = $installer->getConnection()
            ...
            ->addIndex(
                $installer->getIdxName('ordersexporttool_functions', ['id']),
                ['id']
            )
            ->setComment('Mass Order Export Custom Functions Table');
