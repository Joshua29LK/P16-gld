...
use Bss\RequiredProduct\Helper\Data;

/**
 * Class Bss\RequiredProduct\Block\Product\View\RequiredProducts
 */
class RequiredProducts extends Attributes
{
     ...
     * @var string
     */
    protected $productListTemplate = 'Bss_RequiredProduct::product/list/items.phtml';
