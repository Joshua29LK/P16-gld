...
class Revalidate extends Action //implements HttpGetActionInterface
{
    ...
    public function execute()
    {
        ...
        $existingValidation = $this->validationRepository->get($id);
        ...
        try {
            ...
            $result = $this->service->validate($vatCc, $vatNumberWithoutCc, true);

            if ($result->getVatIsValid()) {
                $this->messageManager->addSuccessMessage(
                    __('The VAT number ' . $result->getVatRequestCountryCode().$result->getVatId() . ' is valid.')
                );
            } else {
                $this->messageManager->addErrorMessage(
                    __('The VAT number ' . $result->getVatRequestCountryCode().$result->getVatId() . ' is invalid.')
                );
            }
