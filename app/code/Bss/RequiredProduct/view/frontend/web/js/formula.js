...
Itoris.PriceFormula = {
    ...
    initialize: function(conditions, optionsData, specialPrice, dataBySku, productId, conversionRate, taxInfo, tierPrices) {
        ...
        this.getPriceBox().on('reloadPrice', function(ev){
            ...
            var finalPriceInput = jQuery('.product-add-form');
            if (oldPriceObj[0]) curObj.updatePriceInPriceBoxObject(oldPriceObj, oldPriceObj, finalPriceInput);
            ...
            var finalPriceInput = jQuery('.product-add-form input[name="final_price"]');
            ...
            curObj.updatePriceInPriceBoxObject(basePriceObj, finalPriceObj, finalPriceInput);
    ...
    updatePriceInPriceBoxObject: function(basePriceObj, finalPriceObj, finalPriceInput = null){
        var curObj = this;
        ...
        finalPriceInput.attr('value', curObj.finalPrice * (!curObj.priceFormulaTaxInfo.priceAlreadyIncludesTax && curObj.priceFormulaTaxInfo.displayPriceMode > 1 ? taxRate : 1))
