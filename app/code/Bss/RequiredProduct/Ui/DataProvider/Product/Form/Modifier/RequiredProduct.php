...
namespace Bss\RequiredProduct\Ui\DataProvider\Product\Form\Modifier;
...
/**
 * Class Bss\RequiredProduct\Ui\DataProvider\Product\Form\Modifier\RequiredProduct
 */
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'label' => __('Related Collection %1', $number),
                        'collapsible' => false,
                        'componentType' => Fieldset::NAME,
                        'dataScope' => '',
                        'sortOrder' => $number * 10,
