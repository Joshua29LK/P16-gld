...
class SuggestNotification extends Template
{
     ...
     * @var string
     */
    private $suggestLink = 'https://amasty.com/docs/doku.php?id=magento_2:shipping-rules&utm_source=extension' .
    '&utm_medium=backend&utm_campaign=suggest_shiprules#additional_packages_provided_in_composer_suggestions';

    /**
     * @var string
     */
    protected $_template = 'Amasty_Shiprules::config/information/suggest_notification.phtml';
