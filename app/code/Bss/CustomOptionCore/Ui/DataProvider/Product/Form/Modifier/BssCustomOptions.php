 ...
 */
namespace Bss\CustomOptionCore\Ui\DataProvider\Product\Form\Modifier;
...
{
    const FIELD_IS_USE_DEFAULT_BSS_DESCRIPTION_OPTION_TYPE = 'is_use_default_bss_description_option_type';
    const FIELD_IS_USE_DEFAULT_BSS_DESCRIPTION_OPTION = 'is_use_default_bss_description_option';
    ...
    protected function getHeaderContainerConfig($sortOrder)
    {
        ...
        $this->eventManager->dispatch(
            'bss_custom_options_get_header_container',
    ...
    public function getSelectTypeGridChildConfig()
    {
        ...
        $this->eventManager->dispatch(
            'bss_abs_custom_options_select_type_add_child_before',
            ['child' => $childObject]
        );
        $this->eventManager->dispatch(
            'bss_custom_options_template_select_type_add_child_before',
            ['child' => $childObject]
        );
        $sortedChild = $childObject->getData();
        ksort($sortedChild);
