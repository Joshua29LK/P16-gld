...
class MageplazaOsc
{
    ...
    public function afterProcess(
        ...
        //$this->logger->vatDebug("mageplazaLayout: " . var_export($mageplazaLayout, true));
        ...
        if (isset($jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']
            ...
            $this->logger->customLog("OriginalLayout: " . var_export($originalLayout, true));
        }
        ...
        $fieldLayout = [
            ...
            'dataScopePrefix' => $originalLayout['dataScopePrefix'] ?? 'billingAddress',
            'visible' => true,
            //'sortOrder' => 120,
            'validation' => $this->configHelper->getFieldValidationAtCheckout()
        ];
        $fieldLayout = array_merge($originalLayout, $fieldLayout);
        $this->logger->customLog("Merged Layout: " . var_export($fieldLayout, true));

        //Add field to shipping address
        $fieldLayout['dataScopePrefix'] = 'shippingAddress';
        $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']
        ['billingAddress']['children']['billing-address-fieldset']['children']['vat_id'] = $fieldLayout;

        //$this->logger->vatDebug(var_export($jsLayout['components']['checkout']['children']['steps']['children']
