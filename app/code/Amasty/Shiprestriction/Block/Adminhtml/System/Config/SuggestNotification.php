...
class SuggestNotification extends Template
{
     ...
     * @var string
     */
    private $suggestLink = 'https://amasty.com/docs/doku.php?id=magento_2:shipping-restrictions&utm_source=extension'
    . '&utm_medium=backend&utm_campaign=suggest_shiprestrict#additional_packages_provided_in_composer_suggestions';

    /**
     * @var string
     */
    protected $_template = 'Amasty_Shiprestriction::config/information/suggest_notification.phtml';
