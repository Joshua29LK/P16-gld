...
namespace Bss\RequiredProduct\Plugin;

use Bss\RequiredProduct\Model\ProductFactory;
use Bss\RequiredProduct\Model\ProductLink\CollectionProvider\RequiredLinkProducts;

/**
 * Class Bss\RequiredProduct\Plugin\UpdateToCustomLinkModel
 */
