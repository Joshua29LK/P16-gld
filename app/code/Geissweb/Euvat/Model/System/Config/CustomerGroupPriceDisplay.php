...
use Geissweb\Euvat\Block\System\Config\Field\CustomerGroup;
use Geissweb\Euvat\Block\System\Config\Field\PriceDisplayType;
use Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray;
use Magento\Framework\DataObject;

/**
 * Class CustomerGroupPriceDisplay renders configuration
 */
class CustomerGroupPriceDisplay extends AbstractFieldArray
{
     ...
     */
    protected function _prepareArrayRow(DataObject $row): DataObject
    {
        ...
        if ($displayType !== null) {
            $options['option_' . $this->_getDisplayTypeRenderer()
                ->calcOptionHash($displayType)] = 'selected="selected"';
        }
    ...
    /**
     * Gets the display type renderer
     *
     * @return mixed
     * @throws \Magento\Framework\Exception\LocalizedException
     */
