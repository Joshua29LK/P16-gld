...
namespace Bss\RequiredProduct\Setup\Patch\Data;
...
/**
 * Class Bss\RequiredProduct\Setup\Patch\Data\AddRequireProductAttribute
 */
    ...
    public function apply()
    {
        ...
        for ($i = 1; $i <= self::NUMBER_ATTRIBUTES; $i++) {
            $eavSetup->addAttribute(
                ...
                [
                    'type' => 'varchar',
                    'label' => sprintf('Related Collection Name %s', $i),
                    'input' => 'text',
                    'source' => '',
                    'frontend' => '',
                    'required' => false,
                    ...
                    'unique' => false,
                    'apply_to' => '',
                    'group' => 'Related Collection Attributes',
