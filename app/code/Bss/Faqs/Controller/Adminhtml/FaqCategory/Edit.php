...
class Edit extends Action
{
    ...
    {
        $faqCateId = (int)$this->getRequest()->getParam('faq_category_id', 0);
        $this->coreRegistry->register('faq_category_id', $faqCateId);
        $headerText = ($faqCateId == 0) ? __('Add New FAQ Category') : __('Edit FAQ Category');
