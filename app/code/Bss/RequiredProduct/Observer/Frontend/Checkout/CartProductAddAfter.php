...
namespace Bss\RequiredProduct\Observer\Frontend\Checkout;
...
use Bss\RequiredProduct\Model\Cart;
use Bss\RequiredProduct\Model\RequiredConfiguration;

/**
 * Class Bss\RequiredProduct\Observer\Frontend\Checkout\CartProductAddAfter
 */
