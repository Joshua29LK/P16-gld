    ...
    private function convertSerializedDataToJson(\Magento\Framework\Setup\ModuleDataSetupInterface $setup)
    {
        if ($this->moduleManager->isEnabled('Geissweb_Euvat')) {
            ...
            try {
                ...
                echo PHP_EOL . "Setup was unable to convert the data into JSON! See core_config_data paths
                euvat/group_price_display: catalog_price_display, cart_product_price_display,
                cart_subtotal_price_display." . PHP_EOL;
