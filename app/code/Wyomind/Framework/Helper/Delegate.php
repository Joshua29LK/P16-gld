 ...
 */
namespace Wyomind\Framework\Helper;  class Delegate extends \Wyomind\Framework\Helper\License {public $x4aa0b=null;public $xc6c74=null;public $x6fec3=null; const VERSION = "\67\56\61\x2e\61\61"; public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\App\Helper\Context $context) { parent::__construct($objectManager, $context); $this->constructor($this, func_get_args(), __CLASS__); } protected function getDelegation() { ${$this->x6fec3->x83->xb7} = "\\"; return [ ]; } }