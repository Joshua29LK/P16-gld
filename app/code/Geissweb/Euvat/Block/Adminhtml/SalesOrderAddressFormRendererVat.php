    ...
    public function getValidateButton()
    {
        if ($this->_validateButton === null) {
            ...
            $vatValidateOptions = $this->_jsonEncoder->$jsonMethod([
                    ...
                    'vatValidAndGroupValidMessage' =>
                        __('The VAT ID is valid. The current Customer Group will be used.'),
                    'vatValidAndGroupInvalidMessage' =>
                        __('The VAT ID is valid but no Customer Group is assigned for it.'),
                    'vatValidAndGroupChangeMessage' =>
                        __('Based on the VAT ID, the customer belongs to the Customer Group %s.')."\n".$groupMessage,
