...
{
    /** Url path */
    const BLOG_URL_PATH_EDIT = 'megamenu/menu/edit';
    const BLOG_URL_PATH_DELETE = 'megamenu/menu/delete';
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['menu_id'])) {
                    ...
                    $item[$name]['delete'] = [
                        ...
                        'label' => __('Delete'),
                        'confirm' => [
                            'title' => __('Delete '.$item['menu_name']),
                            'message' => __('Are you sure you wan\'t to delete a '.$item['menu_name'].'?')
                        ]
                    ];
                }
            }
