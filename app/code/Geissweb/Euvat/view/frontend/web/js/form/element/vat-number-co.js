...
define([
    ...
    return VatNumberBase.extend({
        ...
        // Prevent doubled validation on page hard reload
        validate: function () {
            var address;
            if(!this.isBillingField) {
                ...
                if( address === null
                    ...
                    || Utils.isEmpty(address.vatId)
                    || this.value() !== address.vatId
                ) {
                    this._super();
                }
                ...
                if(address === null || this.value() !== address.vatId) {
                    this._super();
                }
            }
        },
        ...
        afterValidation: function (jqXHR) {
            ...
            if (!self.isBillingField) {
                queue.addFunction(function () {
                    return Reloader.setShippingInfo();
                });
            }
